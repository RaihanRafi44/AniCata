...
fun FilterTopManga(
    ...
    val selectedDisplayName = filterOptions.find { it.second == selectedFilterApiValue}?.first ?: "All Manga"
...
fun FilterTopMangaPreview() {
    ...
    FilterTopManga(selectedFilterApiValue = "airing", onFilterSelected = {})
}
